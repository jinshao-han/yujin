...
```html
#wrapper { display: flex; } #text { white-space: nowrap; text-overflow: ellipsis; overflow: hidden; flex: 1; }

<div id="wrapper">
  <div id="text">长文本长文dbsgvkjdabkajgbkjdalbsgkljfbkljadsbgkbadskljbgkljadsb hewfoihngfewakjoh ;ewoia</div>
  <button>test</button>
</div>
```
