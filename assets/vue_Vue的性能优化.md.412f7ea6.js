import{_ as s,c as n,o as a,a as p}from"./app.7c7a7466.js";const A=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"vue/Vue的性能优化.md","lastUpdated":1679387290000}'),l={name:"vue/Vue的性能优化.md"},e=p(`<div class="language-js line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki one-dark-pro vp-code-dark"><code><span class="line"><span style="color:#D19A66;">1</span><span style="color:#ABB2BF;">、</span><span style="color:#98C379;">\`v-if\`</span><span style="color:#61AFEF;">和</span><span style="color:#98C379;">\`v-show\`</span></span>
